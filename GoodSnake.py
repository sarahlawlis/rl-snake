...
class Agent:
    def __init__(self, input_dim=11, output_dim=3, hidden_dim=128, lr=0.0001, gamma=0.99, epsilon_decay=0.995):
        self.model = DQN(input_dim, hidden_dim, output_dim).to(device)
        self.target_model = DQN(input_dim, hidden_dim, output_dim).to(device)
